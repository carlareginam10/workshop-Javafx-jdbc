...
public class SellerFormController implements Initializable {
	...
	public void onBtSaveAction(ActionEvent event) {
		...
		try {
			...
			// Estou pegando uma referencia pra janela atual e chamo a opção close pra
			// fechar a janela
	...
	public void updateFormData() {
		...
		// jogar nas caixas de texto do form os dados que estão no objeto entity do tipo
		// deparment
		// String.valueOf foi colocado pq a cx de texto trabalha com string, então tenho
		// que converter o Id da entidade que é inteiro para string
